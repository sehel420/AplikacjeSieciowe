...
{block name=footer} Domyślna treść stopki .... {/block}
        ...
        <p>Strona została przygotowana na podstawie zadania <a href="http://kudlacik.eu/content/prz_jpsi/projects/resources/php_05_obiektowosc.zip" target="_blank">php_06_b/a></p>
    </div>
